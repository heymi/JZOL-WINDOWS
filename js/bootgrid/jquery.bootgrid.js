    ...
    Grid.prototype.remove = function(rowIds)
    {
        if (this.identifier != null)
        {
            ...
            //{
                ...
                {
                    id = rowIds[i];
                    //Thomas change rows to currentRows, === to ==
                    for (var j = 0; j < this.currentRows.length; j++)
                    {
                        if (this.currentRows[j][this.identifier] == id)
                        {
                            removedRows.push(this.currentRows[j]);
                            this.currentRows.splice(j, 1);
                            break;
                        }
                    }
                }

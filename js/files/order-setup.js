...
//				postData.qualification = demands_info.employee_education;
      ...
      var contractNeededData = {};
      contractNeededData.userName = demands_info.employer_name;
      contractNeededData.eename = bill_info.employee_name;
      contractNeededData.type = paramMap['service_range'][demands_info.type];
      store('contract_needed_data', contractNeededData);
      $('#add_contract').attr('onclick', "location.href='add-contract.html?oid=" + bill_id + "&eeid=" + bill_info.employee_id + "&eid=" + demands_info.employer_id + "&status=" + bill_info.bill_status + "&type=" + demands_info.type + "&did=" + demands_info.id + "'");
    }
  })
});